...
abstract class BaseUsuarioPeer {
	...
	public static function doCountJoinRol(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UsuarioPeer::USU_ROL_ID,), array(RolPeer::ROL_ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseUsuarioPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseUsuarioPeer', $c, $con);
		...
		$c->addJoin(array(UsuarioPeer::USU_ROL_ID,), array(RolPeer::ROL_ID,), $join_behavior);
